...
O back-end do projeto está hospedado no endereço https://food-explorer-back-end-bles.onrender.com. A aplicação Food Explorer está disponível para uso [aqui](https://food-explorer-menu.netlify.app).
